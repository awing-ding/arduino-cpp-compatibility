...
Once you compiled the code into a static library, you can simply import the header provided "libarddebug.hpp", if you compiled the library under a different name, you should rename the provided header.
...
- Implement more functions from [https://www.arduino.cc/reference/en/](arduino) as for now only a few parts (Time, Digital I/O) are fully supported
